...
#define FROM        "pan2021@yahoo.com"
#define TO          "dm122@hw.ac.uk"
//#define CC          "otheruser@domain.com"
//#define BCC         "otheruser@domain.com"
#define SMTPSERVER  "smtp.mail.yahoo.com"
#define SMTPPORT    587
#define SMTPUSER    "pan2021@yahoo.com"
#define SMTPPASS    "oyukireo22"
...
int main ()
{
  ...
  quickmail_set_body(mailobj, "Hi there, here you fabulous flatmate.\nGuess how I sent this email?");
  //quickmail_add_body_memory(mailobj, NULL, "This is a test e-mail.\nThis mail was sent using libquickmail.", 64, 0);
  quickmail_add_body_memory(mailobj, "text/html", "Hi there, here you fabulous flatmate.<br/>\nGuess how I sent this email?", 80, 0);
/**/
